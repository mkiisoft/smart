...
import com.mkiisoft.bluesmart.utils.paginggridview.LoadingView;
import com.mkiisoft.bluesmart.utils.paginggridview.PagingBaseAdapter;

import java.util.List;


public class PagingGridView extends com.mkiisoft.bluesmart.utils.paginggridview.HeaderGridView {
	...
	private com.mkiisoft.bluesmart.utils.paginggridview.LoadingView loadinView;
	...
	public void onFinishLoading(boolean hasMoreItems, List<? extends Object> newItems) {
		...
		if(newItems != null && newItems.size() > 0) {
			...
			if(adapter instanceof com.mkiisoft.bluesmart.utils.paginggridview.PagingBaseAdapter) {
